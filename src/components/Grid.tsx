...
//   const [selectedAlgo, setSelectedAlgo] = useState<"bfs" | "dfs" | "">(""); // State for selected algorithm
...
//             value={selectedAlgo} 
//             onChange={(e) => {
//               const value = e.target.value; // Retrieve value from the event target
//               // Narrow the type to "bfs" | "dfs" if valid
